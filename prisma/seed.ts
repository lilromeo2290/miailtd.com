...
async function seed() {
  ...
  const equipmentList = [
    {
      slug: 'cat-330bl-excavator-30t',
      name: 'Excavator 30 tons',
      category: 'Excavators',
      model: 'CAT 330BL',
      description: 'Heavy-duty 30-ton hydraulic excavator for large-scale excavation, earthmoving, and heavy construction. Delivers exceptional digging force and reach for demanding earthworks and mining support operations.',
      specifications: JSON.stringify({ 'Operating Weight': '30,000 kg', 'Engine Power': '250 HP', 'Bucket Capacity': '1.4 m³', 'Max Dig Depth': '7,380 mm', 'Max Reach': '11,100 mm', 'Travel Speed': '5.0 km/h' }),
      operatingCap: '30,000 kg operating weight',
    ...
    {
      slug: 'cat-322bl-excavator-20t',
      name: 'Excavator 20 tons',
      category: 'Excavators',
      model: 'CAT 322BL',
      description: 'Versatile 20-ton hydraulic excavator ideal for general excavation, trenching, and material handling on road construction and earthworks projects. Reliable performance with excellent fuel efficiency.',
      ...
      operatingCap: '20,200 kg operating weight',
      availability: 'Available',
      dailyRate: 850,
      weeklyRate: 4500,
      monthlyRate: 15000,
    ...
    {
      slug: 'komatsu-pc100-excavator-5t',
      name: 'Excavator 5 tons',
      category: 'Excavators',
      model: 'Komatsu PC 100',
      description: 'Compact 5-ton mini excavator perfect for tight urban spaces, utility trenching, small-scale excavation, and site preparation work where maneuverability is essential.',
      specifications: JSON.stringify({ 'Operating Weight': '5,000 kg', 'Engine Power': '36 HP', 'Bucket Capacity': '0.2 m³', 'Max Dig Depth': '3,580 mm', 'Max Reach': '5,530 mm', 'Travel Speed': '4.5 km/h' }),
      operatingCap: '5,000 kg operating weight',
      availability: 'Available',
      dailyRate: 400,
      weeklyRate: 2100,
      monthlyRate: 7000,
    ...
    },
    {
      ...
      category: 'Bulldozers',
      model: 'CAT D6M',
      description: 'Medium-track-type bulldozer for medium-duty earthmoving, land clearing, grading, and push-loading operations. Excellent maneuverability for road construction and site preparation.',
      specifications: JSON.stringify({ 'Operating Weight': '18,500 kg', 'Engine Power': '165 HP', 'Blade Capacity': '4.2 m³ (SU)', 'Ground Pressure': '52 kPa', 'Width': '3,190 mm', 'Track Length': '2,860 mm' }),
      operatingCap: '18,500 kg, 4.2 m³ blade',
      availability: 'Available',
      dailyRate: 950,
      weeklyRate: 5000,
      monthlyRate: 17000,
    ...
    {
      slug: 'cat-135h-grader',
      name: 'Grader',
      category: 'Motor Graders',
      model: 'CAT 135H',
      description: 'Precision motor grader for road construction, maintenance grading, ditch cutting, and finishing work. Delivers accurate grade control for smooth, properly crowned road surfaces.',
      specifications: JSON.stringify({ 'Operating Weight': '15,800 kg', 'Engine Power': '180 HP', 'Blade Length': '3,660 mm', 'Max Turning Radius': '7.2 m', 'Moldboard Lift': '480 mm', 'Moldboard Side Shift': '500 mm' }),
      operatingCap: '15,800 kg, 3.66m blade',
      availability: 'Available',
      dailyRate: 900,
      weeklyRate: 4800,
      monthlyRate: 16000,
    ...
    },
    {
      ...
      model: 'JCB 3CX',
      description: 'Versatile backhoe loader combining excavation and loading capabilities. Ideal for utility work, small excavations, material handling, and general site operations.',
    ...
    {
      slug: 'cat-950f-payloader',
      name: 'Payloader',
      category: 'Wheel Loaders',
      model: 'CAT 950F',
      description: 'Reliable wheel loader for material handling, truck loading, stockpile management, and general construction tasks. Quick coupler system allows versatile attachment use across different job requirements.',
      specifications: JSON.stringify({ 'Operating Weight': '23,500 kg', 'Engine Power': '215 HP', 'Bucket Capacity': '3.1 m³', 'Breakout Force': '155 kN', 'Steering': 'Articulated', 'Max Speed': '37 km/h' }),
      operatingCap: '23,500 kg, 3.1 m³ bucket',
      availability: 'Available',
      dailyRate: 850,
      weeklyRate: 4500,
      monthlyRate: 15000,
    ...
    {
      slug: 'bomag-bw212d40-roller-18t',
      name: 'Roller Compactor 18 tons',
      category: 'Compactors and Rollers',
      model: 'BOMAG BW212 D-40',
      description: 'Heavy-duty 18-ton vibratory roller compactor for soil and asphalt compaction on road construction projects. Ensures optimal compaction density for durable road bases and surfaces.',
      specifications: JSON.stringify({ 'Operating Weight': '18,000 kg', 'Drum Width': '2,130 mm', 'Centrifugal Force': '320 kN', 'Frequency': '28/35 Hz', 'Amplitude': '1.9/0.9 mm', 'Travel Speed': '0-12 km/h' }),
      operatingCap: '18,000 kg, 2,130mm drum',
      availability: 'Available',
      dailyRate: 750,
      weeklyRate: 4000,
      monthlyRate: 13500,
    ...
    {
      slug: 'bomag-pedestrian-roller-6t',
      name: 'Pedestrian Roller 6 tons',
      category: 'Compactors and Rollers',
      model: 'BOMAG',
      description: 'Medium-weight pedestrian roller for compaction in confined spaces, trenches, and areas where larger rollers cannot operate. Ideal for utility backfill, sidewalk construction, and repair work.',
      specifications: JSON.stringify({ 'Operating Weight': '6,000 kg', 'Drum Width': '1,200 mm', 'Centrifugal Force': '90 kN', 'Frequency': '45 Hz', 'Amplitude': '0.6 mm', 'Travel Speed': '0-6 km/h' }),
      operatingCap: '6,000 kg, 1,200mm drum',
      availability: 'Available',
      dailyRate: 380,
      weeklyRate: 2000,
      monthlyRate: 6800,
    ...
    {
      slug: 'bomag-pedestrian-roller-3t',
      name: 'Pedestrian Roller 3 tons',
      category: 'Compactors and Rollers',
      model: 'BOMAG',
      description: 'Lightweight pedestrian roller for fine compaction work in tight spaces. Perfect for trench compaction, small repairs, landscape work, and areas with limited access for larger equipment.',
      specifications: JSON.stringify({ 'Operating Weight': '3,000 kg', 'Drum Width': '900 mm', 'Centrifugal Force': '48 kN', 'Frequency': '50 Hz', 'Amplitude': '0.5 mm', 'Travel Speed': '0-5 km/h' }),
      operatingCap: '3,000 kg, 900mm drum',
      availability: 'Available',
      dailyRate: 280,
      weeklyRate: 1500,
      monthlyRate: 5000,
    ...
    {
      slug: 'daf-tipper-truck-18m3',
      name: 'Tipper Truck 18m³',
      category: 'Dump Trucks',
      model: 'DAF',
      description: 'Heavy-duty tipper truck with 18m³ body capacity for bulk material transport on construction and road projects. Reliable hauling for earthworks, aggregate delivery, and material removal.',
      specifications: JSON.stringify({ 'Gross Vehicle Weight': '32,000 kg', 'Payload': '18,000 kg', 'Body Volume': '18 m³', 'Tipping Type': 'Hydraulic Front', 'Axles': '6x4', 'Engine Power': '370 HP' }),
      operatingCap: '18,000 kg payload, 18 m³ body',
      availability: 'Available',
      dailyRate: 500,
      weeklyRate: 2700,
      monthlyRate: 9000,
    ...
    {
      slug: 'man-diesel-tipper-truck-18m3',
      name: 'Tipper Truck 18m³',
      category: 'Dump Trucks',
      model: 'MAN DIESEL',
      description: 'Robust MAN Diesel tipper truck with 18m³ body for heavy-duty material hauling. High-torque engine ensures reliable performance on steep gradients and challenging terrain conditions.',
      specifications: JSON.stringify({ 'Gross Vehicle Weight': '33,000 kg', 'Payload': '19,000 kg', 'Body Volume': '18 m³', 'Tipping Type': 'Hydraulic Front', 'Axles': '6x4', 'Engine Power': '390 HP' }),
      operatingCap: '19,000 kg payload, 18 m³ body',
      availability: 'Available',
      dailyRate: 520,
      weeklyRate: 2800,
      monthlyRate: 9500,
